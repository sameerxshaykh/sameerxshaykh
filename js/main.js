		 ...
		 if( direction === 'down' && !$(this.element).hasClass('ftco-animated') ) {
			 ...
			 $('.number').each(function(){
				 ...
				 $this.animateNumber(
					 ...
					 }, 2500 // CD: changed time constraint from 7000 to 2500
				 );
			 });
...
// CD: <textarea> was not yet rendered in $(document).ready
// moved custom logic to window.onload()
window.onload = function () {
 	// CD: logic for using contact form (contact.html)
	 var sendEmail = function () {

		$('#form-btnSend').on('click', function(event) {
			var toEmail = "colefromportland@gmail.com" // CD: default
